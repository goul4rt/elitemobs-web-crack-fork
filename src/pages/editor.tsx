...
import { FloatingMinecraftPreview } from "../features/editor/FloatingMinecraftPreview";
...
const EditorPage = () => {
  ...
  return (
    <>
      <NextSeo
        {...SEO}
        title="Editor | JSON Crack (EliteMobs)"
        description="JSON Crack (EliteMobs) Editor is a tool for visualizing into graphs, analyzing, editing, formatting, querying, transforming and validating JSON, CSV, YAML, XML, and more."
